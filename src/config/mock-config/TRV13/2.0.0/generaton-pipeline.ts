...
function getDetailsByActionId(
	...
	if (entry) {
		console.log("entry is where", entry)
		return {
...
export async function createMockResponseTRV13_200(
	actionID: string,
	...
	let payload1 = await mockAction.generator(payload, sessionData);
	console.log("Generated payload:", JSON.stringify(payload1, null, 2));
	// if (payload1.context)
	return payload1
}
