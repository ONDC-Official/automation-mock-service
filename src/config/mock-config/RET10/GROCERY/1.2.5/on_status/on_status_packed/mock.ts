...
import { on_status_packed_generator } from "./generator";

export class MockOnStatusPacked extends MockAction {
	...
	get description(): string {
		return "Mock action for on_status_packed response from provider.";
	}
	...
	async validate(targetPayload: any): Promise<MockOutput> {
		...
		if (order.state !== "In-progress") {
		  return { valid: false, message: `Invalid order.state: expected 'Packed', got '${order.state}'` };
		}
