...
export const onUpdateIgmReturnGenerator = (
  existingPayload: any,
    ...
    existingPayload.message.order.fulfillments = [
      ...sessionData.fulfillments,
      {
        ...
        tags: [
          ...
          //   ],
          // },
          ...generateQuoteTrail(sessionData?.quote?.breakup || []),
        ],
      },
    ];
  }
...
const generateQuoteTrail = (breakup: any) => {
  const itemQuoteTrail = [] as any;
  const itemTaxTrail = [] as any;
    ...
    if (item["@ondc/org/title_type"] === "item") {
      itemQuoteTrail.push({
        ...
        list: [
          ...
          {
            code: "id",
            value: item["@ondc/org/item_id"] || "item_id_1",
          },
          {
            code: "currency",
            value: "INR",
    ...
    if (item["@ondc/org/title_type"] === "tax") {
      itemTaxTrail.push({
        ...
        list: [
          ...
          {
            code: "value",
            value: `-${Number(item?.price?.value) || "170.00"}`,
          },
        ],
      });
    }
  ...
  return [...itemQuoteTrail, ...itemTaxTrail];
};
