export const OUT_OF_STOCK_ID = "I4-OUT-OF-STOCK";

export const RET10GROCERY125Catalog = JSON.parse(
	JSON.stringify({
		catalog: {
			"bpp/fulfillments": [
				{
					...
					items: [
						{
							descriptor: {
								...
								short_desc: "MUSTARD JK",
								long_desc: "MUSTARD JK",
							...
							"@ondc/org/statutory_reqs_packaged_commodities": {
								...
								common_or_generic_name_of_commodity: "Seeds",
						...
						{
							descriptor: {
								name: "WATERMELON NUNHEMS MADHURI",
								code: "1:7396373975957",
								symbol: "https://sellerNP.com/images/i1.png",
								short_desc: "WATERMELON NUNHEMS MADHURI",
								long_desc: "WATERMELON NUNHEMS MADHURI freshly hand picked",
								images: ["https://sellerNP.com/images/i1.png"],
							},
							rating: "3",
							price: {
