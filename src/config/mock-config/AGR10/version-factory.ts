...
import { createMockResponseAGR10_125 } from "./AGRI_INPUT/1.2.5/generation-pipeline";
...
export async function createMockResponse(
	...
	if (usecaseId === "agriculture-input") {
		if (version === "1.2.5") {
			payload = await createMockResponseAGR10_125(action_id, sessionData, input);
		} else {
